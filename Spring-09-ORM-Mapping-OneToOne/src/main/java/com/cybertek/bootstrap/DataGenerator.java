...
import com.cybertek.repository.DeparmentRepository;
...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Region r1 = new Region("North", "USA");
        Region r2 = new Region("Quebec", "Canada");
        Region r3 = new Region("South", "UK");
        Region r4 = new Region("Chamuva", "Turkey");
        Region r5 = new Region("East Cost", "USA");
